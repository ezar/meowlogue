...
export const en: Record<MessageKey, string> = {
  ...
  'timeline.subtitle': 'Everything I have heard, newest first.',
  'timeline.empty': 'Nothing heard yet. Start listening and come back.',
  'timeline.noMatches': 'Nothing matches these filters.',
  'timeline.clearFilters': 'Clear filters',
  'timeline.filters': 'Filters',
  'timeline.filterCat': 'Cat',
  'timeline.filterType': 'Type',
  'timeline.filterContext': 'Context',
  'timeline.filterState': 'State',
  'timeline.filterDay': 'Day',
  'timeline.any': 'All',
  'timeline.anyDay': 'Any day',
  'timeline.stateConfirmed': 'Confirmed',
  'timeline.stateUnconfirmed': 'Unconfirmed',
  'timeline.stateNotACat': 'Not a cat',
  'timeline.contextNeedsCat': 'Pick a cat to filter by context: labels belong to one cat.',
  'timeline.count': '{count} vocalizations',
  'timeline.countOne': '1 vocalization',
  'timeline.truncated': 'These are the {count} most recent; filter by day to see older ones.',
  'timeline.today': 'Today',
  'timeline.yesterday': 'Yesterday',
  'timeline.open': 'Open',

  'event.title': 'The vocalization',
  'event.notFound': 'That vocalization is gone.',
  'event.noAudio': 'I do not store the audio yet, so there is nothing to play here.',
  'event.spectrogram': 'The shape of the sound',
  'event.noSpectrogram': 'None was kept for this vocalization.',
  'event.measurements': 'What I measured',
  'event.syllablesLabel': 'Syllables',
  'event.duration': 'Duration',
  'event.pitch': 'Pitch (median)',
  'event.contour': 'Contour',
  'event.voiced': 'Voiced fraction',
  'event.centroid': 'Spectral centroid',
  'event.peak': 'Peak',
  'event.trigger': 'Triggering class',
  'event.embedding': 'Voice print',
  'event.embeddingYes': 'stored ({windows} windows)',
  'event.embeddingNo': 'not stored: that session listened without the voice model',
  'contour.rising': 'rising',
  'contour.flat': 'flat',
  'contour.falling': 'falling',
