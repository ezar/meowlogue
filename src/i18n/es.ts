...
export const es = {
  ...
  'timeline.subtitle': 'Todo lo que he oído, de lo más reciente a lo más antiguo.',
  'timeline.empty': 'Todavía no he oído nada. Enciende la escucha y vuelve por aquí.',
  'timeline.noMatches': 'Nada con estos filtros.',
  'timeline.clearFilters': 'Quitar filtros',
  'timeline.filters': 'Filtros',
  'timeline.filterCat': 'Gato',
  'timeline.filterType': 'Tipo',
  'timeline.filterContext': 'Contexto',
  'timeline.filterState': 'Estado',
  'timeline.filterDay': 'Día',
  'timeline.any': 'Todos',
  'timeline.anyDay': 'Cualquier día',
  'timeline.stateConfirmed': 'Confirmados',
  'timeline.stateUnconfirmed': 'Sin confirmar',
  'timeline.stateNotACat': 'No era un gato',
  'timeline.contextNeedsCat':
    'Elige un gato para filtrar por contexto: las etiquetas son de cada gato.',
  'timeline.count': '{count} vocalizaciones',
  'timeline.countOne': '1 vocalización',
  'timeline.truncated': 'Son las {count} más recientes; filtra por día para ver las de antes.',
  'timeline.today': 'Hoy',
  'timeline.yesterday': 'Ayer',
  'timeline.open': 'Ver',

  'event.title': 'La vocalización',
  'event.notFound': 'Esa vocalización ya no está.',
  'event.noAudio':
    'Todavía no guardo el audio de lo que oigo, así que aquí no hay nada que reproducir.',
  'event.spectrogram': 'La huella del sonido',
  'event.noSpectrogram': 'De esta vocalización no guardé ninguna.',
  'event.measurements': 'Lo que medí',
  'event.syllablesLabel': 'Sílabas',
  'event.duration': 'Duración',
  'event.pitch': 'Tono (mediana)',
  'event.contour': 'Contorno',
  'event.voiced': 'Fracción con tono',
  'event.centroid': 'Centro espectral',
  'event.peak': 'Pico',
  'event.trigger': 'Clase que lo disparó',
  'event.embedding': 'Huella de voz',
  'event.embeddingYes': 'guardada ({windows} ventanas)',
  'event.embeddingNo': 'no la guardé: esa sesión escuchó sin el modelo de voces',
  'contour.rising': 'ascendente',
  'contour.flat': 'plano',
  'contour.falling': 'descendente',
